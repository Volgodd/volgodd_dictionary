...
const getOverlayType = (overlayType) => {
  switch (overlayType) {
    case OVERLAY_TYPES.ADD_WORD: return <AddWordOverlay heading={'Add a word'}/>;
    case OVERLAY_TYPES.ADD_THEME: return <AddThemeOverlay heading={'Add a word'}/>;
    default: return <></>
  }
}
...
const Overlay = () => {
  ...
  switch (overlayType) {
    case OVERLAY_TYPES.ADD_WORD: headerString = 'Add a word';
    break
    case OVERLAY_TYPES.ADD_THEME: headerString = 'Add a theme';
    break
    default: <></>
  }
  ...
  <div className={styles.overlayWrapper}>
    <div className={styles.overlayFrame}>
      <div className={styles.overlayHeader}>
        {headerString}
        <MiniButton type={'closeIcon'} onClick={() => setOverlayType()} additionalStyles={styles.closeButton}/>
      </div>
